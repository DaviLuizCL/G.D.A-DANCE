...
String device_name = "ESP32-BRANCO";
...
strip.begin();
  ...
  MihuCore::setServo(braco_esq, 80);//RETO PRA BAIXO
...
// recebido = blu.readStringUntil('\n');
// recebido.trim();
// if(recebido == "B" || recebido == "b") { //OLODUM

// do{
// prox = digitalRead(pino_prox);
// frente_sempre(100);

// }while(prox != 0); //ENQUANTO N ESTA VENDO NADA
// parar();
// delay(1000);
