...
const int rele_esq = 3;
const int rele_dir = 4;
const int rele_meio = 5;
// ================= Funções auxiliares =================
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    if (recebido == 'G' || recebido == 'g') {
      animar = true;
      modoAtual = 1; // barras
      digitalWrite(rele_esq, LOW); //LED LIGADO
      digitalWrite(rele_dir, HIGH);
      digitalWrite(rele_meio, HIGH);
      delay(100);
    } 
